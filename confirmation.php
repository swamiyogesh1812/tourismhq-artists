...
$fb_id = $_REQUEST['id'];
//$_SESSION['FBID'] = $fb_id;
 $query = mysql_query("select * from artists where fb_id = '$fb_id' and directory = '1'");
...
$track = $row['track'];
$location_id = $row['location_based'];
$query_locations = mysql_query("select * from locations where id = '$location_id'");
$row_locations = mysql_fetch_array($query_locations);
$location_name = $row_locations[0]['name'];
           }
